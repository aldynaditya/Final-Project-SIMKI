...
import '../PagesResepsionis/EmrResepsionis.css';
import '../PagesResepsionis/DetailEpsResep.css';
import './EmrPerawat.css';
    ...
    return (
        <div className='emr-resepsionis-container'>
            ...
            <div className='button-emr-perawat'>
                <button type="submit" className="simpan-emr-perawat" onClick={SimpanEmr}>Simpan</button>
            </div>
            <RiwayatEpisode />
            <FooterPrivate />
        </div>
