...
router.get('/vitalsign/:id', authenticateUser, authorizeRoles( 'dokter', 'perawat', 'resepsionis'), findOnevitalsign);
...
router.get('/medical-records/:id', authenticateUser, authorizeRoles('dokter', 'perawat', 'resepsionis'), indexformedicalrecord);
router.get('/medical-record/:id', authenticateUser, authorizeRoles('dokter', 'perawat', 'resepsionis'), findformedicalrecord);
